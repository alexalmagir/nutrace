...
Nutrace is being built using a **6-agent AI system** running on Claude (Anthropic), operated through Claude Code. Each agent has a defined role, a structured response format, and a set of GitHub artifacts they are responsible for producing.
...
```
feat: init nutrace repo — Phase A complete
docs: add project charter, founder brief, CLAUDE context and AI build log
